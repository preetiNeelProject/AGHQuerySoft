...
<div class="container">
  <div class="form-style-8">
  	<a href="${pageContext.request.contextPath}/dsi?obj=ag"><button class="btn btn-primary" style="float: right; margin-right: 10px; cursor: pointer;">Reset</button></a>
    <h2 style="text-align: center;">Apply Digital Signatures(AG Office)</h2>
      <form action="dsi" method="post" id="dsiAG">
        <TABLE ALIGN="center" BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH="100%">
        <tr>
            <td>Enter Source Location:
                <input type="text" name="src" required>
            </td>
            <td>Enter Destination Location:
        ...
        <tr>
            <td colspan="3" align="center"><br><input type="button" onclick="document.getElementById('confModal').style.display='block'" value="Apply signatures"></td>
        </tr>
        <tr><td colspan="2"><input type="hidden" name="obj" value="ag"></td></tr>
        </TABLE>
      </form>
