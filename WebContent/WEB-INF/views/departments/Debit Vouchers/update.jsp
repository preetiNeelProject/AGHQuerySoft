...
<br>
<div class="container">   
    <div class="WelTxtSub">Debit Voucher Details</div>
</div>
<div class="form-style-8" style="margin-bottom: 0px; padding-bottom: 0px; ">
    <br><br>
    <dvForm:form action="updateD" id="dvForm" method="post" modelAttribute="dvForm" enctype="multipart/form-data">
        <table class="table">
            <tr>
                <td>
            ...
            <tr>
            	<td>
                	...
                	<dvForm:input type="date" style="width: 250px; height: 35px;" path="date" id="date" required="true"/>
                </td>
            	<td>
        ...
        <dvForm:hidden path="sno"/><dvForm:hidden path="uploadDate"/><dvForm:hidden path="location"/>
    </dvForm:form>
</div>
<br><br><br>