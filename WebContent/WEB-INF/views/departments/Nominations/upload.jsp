...
<br>
<div class="container">   
    <div class="WelTxtSub">Upload Nomination Record</div>
</div>
<div class="form-style-8" style="margin-bottom: 0px; padding-bottom: 0px; ">
<a href="${pageContext.request.contextPath}/upload?department=Nominations"><button class="btn btn-primary" style="float: right; margin-right: 10px; cursor: pointer;">Reset</button></a>
    <br><br>
    <nomForm:form action="uploadN" id="nomForm" method="post" modelAttribute="nomForm" enctype="multipart/form-data">
        <table class="table">
            <tr>
                <td>
