...
<br>
<div class="container">   
    <div class="WelTxtSub">Pension Record Details</div>
</div>
<div class="form-style-8" style="margin-bottom: 0px; padding-bottom: 0px; ">
    <br><br>
    <pensionForm:form action="updateP" id="pensionForm" method="post" modelAttribute="pensionForm" enctype="multipart/form-data">
        <table class="table">
            <tr>
                <td>
        ...
        <pensionForm:hidden path="sno"/><pensionForm:hidden path="uploadDate"/><pensionForm:hidden path="location"/>
    </pensionForm:form>
</div>
<br><br><br>