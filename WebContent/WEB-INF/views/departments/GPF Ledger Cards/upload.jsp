...
<br>
<div class="container">   
    <div class="WelTxtSub">Upload GPF Ledger Card</div>
</div>
<div class="form-style-8" style="margin-bottom: 0px; padding-bottom: 0px; ">
<a href="${pageContext.request.contextPath}/upload?department=GPF Ledger Cards"><button class="btn btn-primary" style="float: right; margin-right: 10px; cursor: pointer;">Reset</button></a>
    <br><br>
    <gpfForm:form action="uploadG" id="gpfForm" method="post" modelAttribute="gpfForm" enctype="multipart/form-data">
        <table class="table">
            <tr>
                <td>
